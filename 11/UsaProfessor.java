...
public class UsaProfessor {
	...
	public static void main(String[] args) {
		...
		Professor pf1 = new Professor(Integer.parseInt(JOptionPane.showInputDialog("Informe o código: ")), 
				...
				JOptionPane.showInputDialog("Informe a titulação: "),Integer.parseInt(JOptionPane.showInputDialog("Informe o número de turmas: ")));
		pf1.calculaSalario();
		pf1.exibirDados();
	}
}
